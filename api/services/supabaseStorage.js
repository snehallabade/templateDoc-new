...
exports.supabaseStorage = exports.supabase = void 0;
var supabase_js_1 = require("@supabase/supabase-js");
if (!process.env.VITE_SUPABASE_URL || !process.env.VITE_SUPABASE_ANON_KEY) {
    throw new Error('Missing Supabase environment variables');
}
exports.supabase = (0, supabase_js_1.createClient)(process.env.VITE_SUPABASE_URL, process.env.VITE_SUPABASE_ANON_KEY);
exports.supabaseStorage = {
    uploadFile: function (buffer, bucket, fileName) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        publicUrl = exports.supabase.storage
                            .from(bucket)
